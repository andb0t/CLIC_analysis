#ifndef TrackCutChecker_h
#define TrackCutChecker_h 1
 ...
 *
 * @author F. Gaede, DESY
 * @version $Id: TrackCutChecker.h,v 1.4 2005-10-11 12:57:39 gaede Exp $
 */

class TrackCutChecker : public Processor {

 public:

  virtual Processor*  newProcessor() { return new TrackCutChecker ; }
