...
\begin{itemize}
%
\item important for EFT (Effective Field Theory) analyses \href{https://link.springer.com/content/pdf/10.1007/JHEP05(2017)096.pdf}{JHEP 05, 096 (2017)}
%
\end{itemize}
\end{frame}
...
\item refine the event selection
\end{itemize}
...
\item add the new functionality while leaving the old functionality fully intact
\end{itemize}
