...
\begin{frame}{\Wboson\ mass correlation}
\begin{figure}
\includegraphics[width=0.5\textwidth]{{\figurepath/raw_mc_qq_m_vs_mc_qq_ln}.pdf}
\includegraphics[width=0.5\textwidth]{{\figurepath/fin_mc_qq_m_vs_mc_qq_ln}.pdf}
\caption{
  Correlation for signal before and after selection cuts.
}
\end{figure}
\end{frame}
