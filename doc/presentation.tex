...
\begin{frame}{}
\begin{figure}
\includegraphics[width=0.5\textwidth]{{\figurepath/raw_sf}.pdf}
\includegraphics[width=0.5\textwidth]{{\figurepath/raw_lep_n}.pdf}\\ \tripleFigDistance
\includegraphics[width=0.5\textwidth]{{\figurepath/pre_sf}.pdf}
\includegraphics[width=0.5\textwidth]{{\figurepath/pre_lep_n}.pdf}\\ \tripleFigDistance
\includegraphics[width=0.5\textwidth]{{\figurepath/fin_sf}.pdf}
\includegraphics[width=0.5\textwidth]{{\figurepath/fin_lep_n}.pdf}
\caption{
  The appliedscale factors and the number of leptons
}
\end{figure}
\end{frame}
