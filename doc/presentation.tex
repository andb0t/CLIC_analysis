...
\item assume a number of observed data events: \newline
  $N^\mathrm{final} := \lumi \cdot X = \datalumi \cdot \signalxs = \ndata$
...
\item calculate the assumed number of signal events in the data: \newline
...
\vspace{1em}
The total \xsec\ of \eeto\qqln is determined to be $\xSec~\fb$.
