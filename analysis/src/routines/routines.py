...
def kinematic_figures(plotCont, savePrefix='', savePlots=True, mode='stacked', normed=True):
    ...
    stdPlots.plot_hist(plotCont, 'theta_W', (-3.2, 3.2), 40, xlabel=r'$\theta_{W}$', mode=mode, normed=normed, save='theta_W.pdf')
    stdPlots.plot_hist(plotCont, 'theta_L', (-3.2, 3.2), 40, xlabel=r'$\theta_{L}$', mode=mode, normed=normed, save='theta_L.pdf')
    stdPlots.plot_hist(plotCont, 'theta_H', (-3.2, 3.2), 40, xlabel=r'$\theta_{H}$', mode=mode, normed=normed, save='theta_H.pdf')
