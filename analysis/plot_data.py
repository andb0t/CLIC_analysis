...
rawPlots.plot_hist([sigCont, bkg0Cont, bkg1Cont], settings.LEP + 'etot', (0, 1000), 40, xlabel='Lepton E$_{tot}$ [GeV]', save='lep_etot.pdf')
...
rawPlots.plot_hist([sigCont, bkg0Cont, bkg1Cont], settings.JET + 'n', (0, 6), 6, xlabel='N$_{jet}$', save='jet_n.pdf')
...
# rawPlots.plot_scatter([sigCont, bkg0Cont, bkg1Cont], settings.JET + 'pt_1', settings.JET + 'pt_0', (0, 600), (0, 400),  xlabel='Subleading jet p$_{T}$ [GeV]', ylabel='Leading jet p$_{T}$ [GeV]',save='jet_pt0_vs_pt1.pdf')
...
cutPlots.plot_hist([sigCont, bkg0Cont, bkg1Cont], settings.LEP + 'etot', (0, 1000), 40, xlabel='Lepton E$_{tot}$ [GeV]', save='lep_etot.pdf')
...
cutPlots.plot_hist([sigCont, bkg0Cont, bkg1Cont], settings.JET + 'n', (0, 6), 6, xlabel='N$_{jet}$', save='jet_n.pdf')
...
finalPlots.plot_hist([sigCont, bkg0Cont, bkg1Cont], settings.LEP + 'etot', (0, 1000), 40, xlabel='Lepton E$_{tot}$ [GeV]', save='lep_etot.pdf')
...
finalPlots.plot_hist([sigCont, bkg0Cont, bkg1Cont], settings.JET + 'n', (0, 6), 6, xlabel='N$_{jet}$', save='jet_n.pdf')
